...
public class NutsShells extends Fallingobjects
{
    
    private static final String Image="Import/Shell.png";
     private ImageView [] sa ;

    
    public NutsShells(double x,double y,Pane p){
    super(x,y);
    createobj(p);
  ...
  public void setxy(ImageView image)
    ...
    public ImageView getShells(int i)
    {
        return sa[i];
    }
