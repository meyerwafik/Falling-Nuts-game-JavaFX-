...
public class Powerup extends Fallingobjects {
     private static final String Image="Import/powerup.gif";
     private ImageView [] sa ;

    
    public Powerup(double x,double y,Pane p){
    super(x,y);
    createobj(p);
    }
    ...
    public void move() {
        ...
        {
            sa[i].setLayoutY(sa[i].getLayoutY()+7);
        }
   ...
   public void setxy(ImageView image)
    ...
    public ImageView getPower(int i)
    {
        return sa[i];
    }
